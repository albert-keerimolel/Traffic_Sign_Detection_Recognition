# -*- coding: utf-8 -*-
"""
Created on Sat Apr 10 04:53:27 2021
...
plt.imshow(Cr)
plt.savefig('red_channel_formula(Cr).png')

Cb = np.maximum(0,np.divide((imgb-imgr),(imgr+imgg+imgb)))
Cb[np.isnan(Cb)]=0

plt.imshow(Cb)
plt.savefig('blue_channel_formula(Cb).png')
